                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="quan_tri_dich_vu.php">Tư vấn</a></li>
                            
                        </ol> 
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Danh sách người đăng kí xét nghiệm
                            </div>
                            <div class="card-body">
                            ...
                            <td><?php echo $row['emai']; ?></td>
                            <td><?php echo $row['sdt']; ?></td>
                            <td><?php echo $row['ngay_xet_nghiem']; ?></td>
                            <td><?php echo $row['ten_loai']; ?></td>
                            <td><?php echo number_format($row['so_tien'], 0, '', ',');?>đ</td>                            
                            <?php if($row['tinh_trang_thanh_toan']==1){?>
                            <td>Đã xét nghiệm</td>
                            <?php } else { ?>
                            <td>Chưa xét nghiệm</td> <?php } ?>                                                         
                            <td><?php echo date_format(new DateTime($row['ngay_thanh_toan']),"d-m-Y"); ?></td>                                                 
                            <td>
                            <span><a class="btn btn-default" href="invoices_detail.php?id=<?php echo $row['order_id']; ?>">Chi tiết</a></span> 
                            <?php if($row['tinh_trang_thanh_toan']==0){?>
                            <a class="btn btn-info" href="done_xet_nghiem.php?id=<?php echo $row['xet_nghiem_id']; ?>">Đã xét nghiệm</a>
                            <?php } ?>                            
                            <span><a class="btn btn-danger" href="del_invoices.php?id=<?php echo $row['xet_nghiem_id']; ?>">Xóa</a></span>
                            </td>
                        </tr>
                                    <?php
                                    }
