                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><b>Xét nghiệm </b></a></li>
                            <li class="breadcrumb-item" <a href="quan_tri_dich_vu.php"><b> Tư vấn</b></li>
                        </ol> 
                        <div class="card mb-4">
                            ...
                            <td>
                            <span><a class="btn btn-default" href="#.php?id=<?php echo $row['order_id']; ?>">Chi tiết</a></span> 
                            ...
                            <?php } ?>                            
                            <span><a class="btn btn-danger" href="quan_tri_xet_nghiem_xoa.php?id=<?php echo $row['xet_nghiem_id']; ?>">Xóa</a></span>
                            </td>
                        </tr>
                                    <?php
                                    }
